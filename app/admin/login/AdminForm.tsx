...
import { adminLogin, AdminLoginState } from "./action"
        ...
        <div className="min-h-screen bg-[#F1EFE9] flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center px-4 py-8">
                <div className="w-full max-w-md">
                    <div className="mb-8">
                        <h1 className="text-3xl font-serif font-bold text-[#1B2233] mb-2">Platform Admin</h1>
                        <p className="text-gray-600">Access the admin panel to manage companies and approvals.</p>
                    </div>
                    ...
                    {!state.success && (
                        <form action={formAction} className="space-y-5 bg-white border border-black/8 rounded-lg p-8">
                            ...
                            <p className="text-center text-sm text-gray-600 mt-4">
                                <Link href="/" className="text-[#B07C34] font-semibold hover:underline">Back to home</Link>
                            </p>
                        </form>
                    )}
                </div>
