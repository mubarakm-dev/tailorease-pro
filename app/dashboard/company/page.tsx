...
function Detail({ label, children }: { label: string; children: React.ReactNode }) {
    return (
        <div>
            <p className="text-xs uppercase tracking-wide text-gray-900 placeholder:text-gray-500">{label}</p>
    ...
    return (
        <div className="p-6 max-w-3xl mx-auto flex flex-col gap-6">
            <div>
                ...
                <p className="text-gray-900 text-sm mt-1">Your company details.</p>
            </div>
