...
export default function CompanyForm({
    ...
    return (
        <form action={formAction} className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-4">
            ...
            <div>
                <label className="block text-sm font-medium text-gray-900 mb-2">Company Logo/Image</label>
                {imagePreview && (
                ...
                <p className="text-xs text-gray-900 mt-1">JPG, PNG, or WebP (max 2MB)</p>
            </div>

            <div>
                <label className="block text-sm font-medium text-gray-900 mb-1">Owner full name</label>
