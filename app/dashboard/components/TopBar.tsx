        ...
        <header className="sticky top-0 z-30 flex items-center gap-4 sm:gap-6 px-4 md:px-6 py-3 bg-white/80 backdrop-blur border-b border-gray-200">
            ...
            <div className="ml-auto flex items-center gap-3">
                ...
                <Link
                    ...
                    className="w-9 h-9 grid place-items-center rounded-lg border border-gray-200 text-gray-500 transition-all duration-300 hover:border-[#b07c34] hover:shadow-[0_8px_16px_rgba(176,124,52,0.15)] hover:-translate-y-0.5 hover:text-[#b07c34]"
                >
